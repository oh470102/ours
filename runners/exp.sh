...
for config_file in ./configs/exp_config/get_6_good_ones/*.yaml; do
  ...
  python sample.py --config "$config_file" --save_dir "./samples/quant_exp/ours_new" --num_inference_steps 500 && 
