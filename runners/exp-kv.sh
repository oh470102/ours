...
for config_file in ./configs/exp_config/kv/*.yaml; do
  ...
  python sample.py --config "$config_file" --save_dir "./samples/quant_exp/ours_qkv_combination/ours_kv" --num_inference_steps 500 && 
