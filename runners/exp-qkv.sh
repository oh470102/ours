...
for config_file in ./configs/exp_config/qkv/*.yaml; do
  ...
  python sample.py --config "$config_file" --save_dir "./samples/quant_exp/ours_qkv_combination/ours_qkv" --num_inference_steps 500 && 
